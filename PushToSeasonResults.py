...
#        '-'+collegeName+'.html'
#        print (gameURL)
#        print (urllib.request.urlopen(gameURL).getcode())
#        print (urllib.request.urlopen(gameURL).info())
#        try:
...
#    print ('Written to SeasonResults')
#    print (schoolName,year,gameofYear,time,day,homeOrAway,opponent,outcome\
#    ,pointsFor,pointsAgainst,wins,losses,streak)
...
#                        RetrieveGameStats(collegeName,year,dateOfGame,opponent,homeOrAway)
    ...
    #                    print ('PointsFor:',pointsFor)
                    elif x == 9:
                        pointsAgainst = (str(tag.contents)[2:-2])
    #                    print ('PointsAgainst:',pointsAgainst)
                    elif x == 10:
